...
- **Holidays:** a Spring Egg Hunt (click the hidden eggs!), Leo's Birthday Party, a Beach & Camping Weekend, Midsummer Fireworks, Pet Adoption Day, the Mid-Autumn Festival (Tết Trung Thu: star lanterns, a lion dance and mooncakes under the full moon), Pumpkin Night, the Winterlight Festival and a New Year's Eve countdown.
